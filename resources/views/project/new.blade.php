            ...
            <form class="form-horizontal" action="{{ url('store') }}" method="post">
                ...
                <fieldset>
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="linkinput">Link</label>
                        <div class="col-md-4">
                            <input id="linkinput" name="linkinput" type="text" placeholder="" class="form-control input-md" required="blaa">
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
